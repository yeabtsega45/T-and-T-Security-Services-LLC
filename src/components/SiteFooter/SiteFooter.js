            ...
            <div className="site-footer__top">
                        ...
                        <Col xl={4} lg={6} md={6} className="animated fadeInUp">
                            <div className="footer-widget__column footer-widget__about">
                                <div className="footer-widget__logo">
                                    <Link href="/">
                                        <Image src={require(`@/images/logo/logo.png`).default.src}
              ...
              <div className="footer-widget__column footer-widget__newsletter-box clearfix">
                ...
                >
                 ...
                 <p className="footer-widget__contact-text">{"7518 Suite M Fullerton Road Springfield Virginia 22153"}</p>
                                <h4 className="footer-widget__contact-info">
                                    <a
                                        href={`mailto:${"info@ttsecurityservicesllc.com"}`}
//                                        className="footer-widget__contact-email"
                                        >
                                        <p className="footer-widget__contact-text" style={{color: 'white', marginBottom: 10}}>
                        ...
                        <Col xl={12}>
                            <div className="site-footer__bottom-inner">
                                <p className="site-footer__bottom-text">
                                    © Copyright {year} by <a href="https://revosolutionplc.com/">{"Revo Solutions PLC"}</a>
                                </p>
                            </div>
                        </Col>
                    </Row>
